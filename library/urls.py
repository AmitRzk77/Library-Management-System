...
from transaction.routers.routers import router as transaction_router
from volume.routers.routers import router as volume_router
...
urlpatterns = [
    ...
    path('api/api-auth', include('rest_framework.urls')), #used for login in apis
